...
python agent/search/retrieval/retrieval_server_asearcher.py --faiss_gpu > server_branpo.log &
PID=$!

conda activate rllm

ex_name=qwen2.5-7b-instruct-branpo
# ex_name=qwen3-4b-instruct-branpo
model_path="path/to/sft/model"

# Stage 1 Training
bash agent/search/start_branpo_trainer.sh \
